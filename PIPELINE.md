...
— конкретний **обраний approved master-look**; якщо вже є approved кадр/зйомка,
він може бути додатковим locked source. Персонаж і образ фіксуються до старту;
style/сцена додаються тільки коли користувач обрав fashion shoot.

| Step | Для користувача | Стан |
| --- | --- | --- |
| `VIDEO.01` | Вибрати збережений master-образ або готовий кадр/фотосесію як source motion. | NOT_DELIVERED |
...
користувач має три рівноправні продовження: **Photoshoot**, **«Зробити
відео»** або **«Live camera»**. Live режим використовує явний дозвіл камери
