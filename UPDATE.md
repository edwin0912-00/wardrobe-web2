...
| BETA-LOOK-NEXT-ACTIONS-001 | LOOK.06 → CHOICE.01 · Чотири кнопки після образу | unassigned | PROPOSED | PRODUCT + CODE | To be reserved after interaction review; no product path is reserved by this proposal. | Make **Додати фон**, **Створити фотозйомку**, **Fashion Video**, and **Live camera** equal entry actions for one approved master-look. Preserve existing truthful video block until real transport is ready. No UI, provider or beta change is authorized by this proposal. |
