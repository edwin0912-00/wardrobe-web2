...
| BETA-GRAIN-002 | claude-code-20260727-a3f1c8 | IN_PROGRESS | CODE | `src/web/frame-finish.js`; `test/contracts/frame-finish.test.js`; `updates/claude-code-20260727-a3f1c8.md` | Make the film grain fine instead of clumped, so it reads as film on skin rather than as mottling; assert the grain size in the contract test. |
