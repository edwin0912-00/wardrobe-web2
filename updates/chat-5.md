...
Code: ACTIVE — current worktree; focused test command below is PASS 49/49.
Beta: NOT_DEPLOYED
Journey: NOT_RUN — controlled provider run follows this code commit.
Evidence command: node --test test/video/video-routes.test.js test/video/video-runtime.test.js test/video/openrouter-video-provider.test.js test/video/video-provider-router.test.js test/video/video-service.test.js test/video/higgsfield-video-provider.test.js test/video/ffprobe-video-probe.test.js
