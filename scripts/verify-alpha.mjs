...
const allowedAlphaOverlay = [
  ...
  ':(exclude)AGENTS.md',
  ':(exclude)CLAUDE.md',
  ':(exclude)COLLAB-BOARD.md',
  ':(exclude)INTEGRATION-HANDOFF.md',
  ':(exclude).gitignore',
  ':(exclude)package.json',
  ':(exclude)package-lock.json',
  ':(exclude)verify',
  ':(exclude).github/workflows/evaluator.yml',
  ':(exclude)self-check/**',
  ':(exclude)scripts/install-local.sh',
  ':(exclude)scripts/install-alpha.sh',
  ':(exclude)scripts/deploy-site.sh',
  ...
  ':(exclude)docs/15-CLAUDE-CODE-SIDEBYSIDE.md',
  ':(exclude)docs/17-LAPTOP-PIPELINE-DECK.md',
  ':(exclude)docs/UNIFIED_PROJECT_MONOREPO_PLAN.md',
