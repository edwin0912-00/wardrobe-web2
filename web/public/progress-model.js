...
export const PIPELINE_ROWS = Object.freeze([
  freezeRow({
    ...
    nodes: [
      ...
      {
        id: 'garment-qa', title: 'Garment Fidelity', code: 'GARMENT_QA', detail: 'raw ↔ canonical · blocking gate',
        input: 'raw views + canonical candidate',
        operation: 'Independent VLM fidelity comparison',
        output: 'approved white card + cutout',
  ...
  freezeRow({
    ...
    nodes: [
      ...
      },
      {
        ...
        operation: 'Independent identity and garment-fidelity QA',
...
export const PROGRESS_STATES = Object.freeze({
  ...
  GARMENT_QA: progress(24, 'garment-qa', 'Перевіряємо fidelity garment reference', 'GARMENT QA'),
